...
**版本提示：** 上方下载包仍为 Alpha.3。下文的独立 AI 总结、可缩放导图和默认高精度转写已在当前源码中实现，尚未包含在该安装包；使用 Alpha.3 时，界面名称和导图形式会有所不同。
...
- **先看结构，再读细节。** 全文转写保留原话，AI 总结提炼结论与重点，思维导图按主题和关键词梳理关系。三种结果分开查看，引用可定位原文。
...
3. **换成自己的内容。** 导入字幕、视频、音频，或粘贴公开视频链接。默认先得到文字；需要 AI 笔记时，再设置模型并生成总结和导图，无需重新转写。
